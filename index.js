...
// the nestedFunction runs and checks the scope of myFunction, since it is inside function scope
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(){
    ...
    zooAnimals.map(function(item) {
      a.push(item.animal_name.toLowerCase());
    })
    return a;
  }
  ...
  */
  ...
  function USApop(){
    var a = zooAnimals.reduce(function(total, item) {
